...
CREATE TABLE IF NOT EXISTS users (
    ...
    savingsIncrease NUMERIC(12, 2), -- amount savings increased by last month only
...
-- Test users
INSERT INTO users (username, user_email, job_title, password, address, city_name, state_name, user_goal, savings, savingsIncrease, investments, weekly_hours, roommates_num, dependents_num, bedrooms_needed, expense_other, expense_groceries, expense_takeout, expense_dining, expense_rent, expense_subscriptions, expense_entertainment, income_job, income_other)
VALUES ('test', 'johndoe@gmail.com', 'developer', '1234', '123 Somewhere Street', 'Fairfax', 'VA', 'debt', '74.34', '21.38', '0.00', '27', '1', '0', '0', '68.12', '113.78', '378.76', '43.12', '1600.00', '89.46', '212.43', '1900.00', '200.00')
VALUES ('John Doe', 'johndoe@gmail.com', 'developer', '1234', '123 Somewhere Street', 'Fairfax', 'VA', 'debt', '74.34', '21.38', '0.00', '27', '1', '0', '0', '68.12', '113.78', '378.76', '43.12', '1600.00', '89.46', '212.43', '1900.00', '200.00')
VALUES ('Jane Doe', 'janedoe@gmail.com', 'Lawyer', '1234', '456 Elsewhere Street', 'Arlington', 'VA', 'retirement', '9819.48', '918.46', '760.14', '40', '0', '1', '2', '113.84', '378.15', '148.76', '245.12', '2900.00', '18.98', '512.43', '7800.00', '900.00')
